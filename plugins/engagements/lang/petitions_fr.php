...
Vous avez demandé à vous engager pour :
@titre@.
...
Vous avez fourni les informations suivantes :
	...
	Membre d'une association d'alumni : @membre_asso_alumni@
	Linkedin : @linkedin@

	Nom de l'entreprise/organisation : @organisation@
	Fonction occupée au sein de l'entreprise/organisation : @fonction_organisation@
	Pays de l'entreprise/organisation : @pays_organisation@
	Ville de l'entreprise/organisation : @ville_organisation@
    @message@

	Autorisation de publier les informations afin d'être contacté par des alumni : @autorisation_infos_publiques@
