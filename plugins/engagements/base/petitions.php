...
function petitions_declarer_tables_interfaces($interfaces) {
	...
	$interfaces['exceptions_des_tables']['signatures']['ecole_alumni'] = "ecole_alumni";
	...
	$interfaces['exceptions_des_tables']['signatures']['pays_organisation'] = "pays_organisation";
	$interfaces['exceptions_des_tables']['signatures']['id_gis_organisation'] = "id_gis_organisation";
	...
	$interfaces['exceptions_des_tables']['ecoles_alumni']['nom'] = "nom";
	...
	$interfaces['tables_jointures']['spip_articles'][] = 'ecoles_alumni';
	...
	foreach (array('PRENOM_EMAIL','NOM_EMAIL', 'ANNEE_NAISSANCE', 'AD_EMAIL', 'ECOLE_ALUMNI', 'PAYS_ECOLE','MEMBRE_ASSO_ALUMNI', 'ORGANISATION','FONCTION_ORGANISATION','PAYS_ORGANISATION','ID_GIS_ORGANISATION','NOM_SITE', 'URL_SITE', 'MESSAGE') as $balise) {
...
#			"id_article"	=> "bigint(21) DEFAULT '0' NOT NULL",
			...
			"ecole_alumni" => "text DEFAULT '' NOT NULL",
			...
			"pays_organisation" => "text DEFAULT '' NOT NULL",
			"id_gis_organisation" => "int DEFAULT '' NOT NULL",
