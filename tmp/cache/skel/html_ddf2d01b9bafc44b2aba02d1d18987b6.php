...
/*
 * Squelette : plugins/auto/saisies/v3.41.0/saisies/_base.html
 * Date :      Sat, 13 Jun 2020 08:52:18 GMT
 * Compile :   Mon, 03 Aug 2020 09:59:48 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette plugins/auto/saisies/v3.41.0/saisies/_base.html
// Temps de compilation total: 11.409 ms
//

function html_ddf2d01b9bafc44b2aba02d1d18987b6($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)) ?' ' :''))))!=='' ?
	...
	'readonly' => table_valeur($Pile["vars"], (string)'readonly', null) )), array('compil'=>array('plugins/auto/saisies/v3.41.0/saisies/_base.html','html_ddf2d01b9bafc44b2aba02d1d18987b6','',12,$GLOBALS['spip_lang'])), _request('connect')) .
		'
	')) :
			'') .
	'
	...
	'describedby' => interdire_scripts((table_valeur(@$Pile[0], (string)'explication', null) ? (($t5 = strval(interdire_scripts(saisie_nom2name(entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)))))!=='' ?
						('explication_' . $t5) :
						''):'')) )), array('compil'=>array('plugins/auto/saisies/v3.41.0/saisies/_base.html','html_ddf2d01b9bafc44b2aba02d1d18987b6','',0,$GLOBALS['spip_lang'])), _request('connect')) .
		'
			' .
...
');
	...
	return analyse_resultat_skel('html_ddf2d01b9bafc44b2aba02d1d18987b6', $Cache, $page, 'plugins/auto/saisies/v3.41.0/saisies/_base.html');
}
?>