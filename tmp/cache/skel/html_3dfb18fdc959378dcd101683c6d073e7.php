...
/*
 * Squelette : plugins/auto/saisies/v3.41.0/saisies.css.html
 * Date :      Sat, 13 Jun 2020 08:52:18 GMT
 * Compile :   Mon, 03 Aug 2020 09:59:49 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette plugins/auto/saisies/v3.41.0/saisies.css.html
// Temps de compilation total: 2.398 ms
//

function html_3dfb18fdc959378dcd101683c6d073e7($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
((find_in_path('prive/style_prive_plugin_bonux.html'))  ?
		(' ' . (	' 
  ' .
	recuperer_fond( 'prive/style_prive_plugin_bonux' , array('ltr' => lang_dir(@$Pile[0]['lang'], 'left','right') ), array('compil'=>array('plugins/auto/saisies/v3.41.0/saisies.css.html','html_3dfb18fdc959378dcd101683c6d073e7','',22,$GLOBALS['spip_lang'])), _request('connect')) .
	'
')) :
		'') .
'
...
');
	...
	return analyse_resultat_skel('html_3dfb18fdc959378dcd101683c6d073e7', $Cache, $page, 'plugins/auto/saisies/v3.41.0/saisies.css.html');
}
?>