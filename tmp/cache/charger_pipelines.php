...
include_once_check(_ROOT_PLUGINS.'auto/zcore/v2.8.7/zcore_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/pages/v1.5.2/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.8.0/compositions_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.41.0/saisies_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS.'couteau_suisse/cout_pipelines.php');
$inc=true;
}
$val = minipipe('f_recuperer_fond', $val);
$val = minipipe('adaptive_images_recuperer_fond', $val);
...
if (!$inc){
include_once_check(_ROOT_RESTREINT.'/inc/pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/crayons/v2.0.13/crayons_fonctions.php');
include_once_check(_ROOT_PLUGINS.'couteau_suisse/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.41.0/saisies_pipelines.php');
$inc=true;
}
...
$val = minipipe('adaptive_images_affichage_final', $val);
...
$val = minipipe('adaptive_images_affiche_milieu', $val);
...
$val = minipipe('compositions_affiche_milieu', $val);
...
$val = minipipe('compositions_declarer_tables_objets_sql', $val);
...
$val = minipipe('adaptive_images_insert_head', $val);
$val = minipipe('lesscss_insert_head', $val);
...
$val = minipipe('compositions_pre_edition', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.8.0/compositions_ieconfig.php');
...
$val = minipipe('compositions_ieconfig_metas', $val);
...
function execute_pipeline_compositions_lister_disponibles(&$val){
return $val;
}
...
$val = minipipe('compositions_compositions_declarer_heritage', $val);
return $val;
}
